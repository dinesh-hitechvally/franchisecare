...
<body>
    <div class="container">
        ...
        <div class="info-box">
            ...
            <p style="margin-bottom: 0;">I, {{ $ownerName }}, acknowledge that I have specifically requested that you use the shampoo I have provided, instead of your Blue Wheelers shampoos to wash my dog(s) for the following reasons:</p>
        </div>

        <div class="section-title">Reason for Using Own Shampoo</div>
        <span class="label">Reason(s) for using own shampoo *</span>
        <div class="text-area">
            {{ $form_data['shampooReason'] ?? '' }}
        </div>
