...
<head>
    ...
    <style>
        ...
        .paid-badge { background: #dcfce7; color: #166534; padding: 5px 15px; border-radius: 4px; font-weight: bold; display: inline-block; margin-top: 20px; }
    </style>
</head>
<body>
    <div class="container">
        <h1>RECEIPT</h1>
        <div class="subtitle">Receipt #{{ $booking->id }}</div>
