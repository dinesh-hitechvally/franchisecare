...
class BookingController extends Controller
{
    ...
    public function sendSmsConfirmation(Booking $booking, Request $request, MessageMediaService $smsService)
    {
        ...
        if (! $smsService->isValidPhoneNumber($customer->phone)) {
            throw ValidationException::withMessages([
        ...
        $record = SmsHistory::create([
            ...
            'to_number' => $smsService->formatPhoneNumber($customer->phone),
