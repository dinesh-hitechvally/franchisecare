...
export function SystemManualsPage() {
  ...
  const manuals = [
    {
      id: '1',
      title: 'MacKay Trailer maintenance manual.',
      file: 'Manual',
      description: 'This document should save you from maintenance problems.',
      type: 'pdf',
      lastUpdated: '2015-11-26 14:27:57'
    }
  ]
            ...
            <table className="w-full text-sm text-left border-collapse">
              <thead className="bg-white border-b border-gray-100">
                <tr>
                  ...
                  <th className="px-6 py-4 font-bold text-gray-400 uppercase text-xs tracking-wider">Download</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-50 bg-white">
                {manuals.map((manual) => (
                  <tr key={manual.id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-gray-600">{manual.file}</td>
                    ...
                    <td className="px-6 py-4 text-gray-500 whitespace-nowrap">{manual.lastUpdated}</td>
                    <td className="px-6 py-4">
