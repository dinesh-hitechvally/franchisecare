...
export function BuyCreditsPage() {
  const packages = [
    { title: 'SMSCredits ($100)', rate: '$0.20/Sms', quantity: '500' },
    { title: 'SMSCredits ($180)', rate: '$0.18/Sms', quantity: '1000' },
  ]
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {packages.map((pkg, idx) => (
          <div key={idx} className="bg-white border border-gray-200 rounded-md overflow-hidden shadow-sm flex flex-col">
            ...
            <div className="p-6 flex flex-col items-center flex-1">
              ...
              <div className="text-center space-y-1 mb-8">
                <p className="text-sm text-gray-600">Rate: <span className="font-medium text-gray-800">{pkg.rate}</span></p>
                <p className="text-sm text-gray-600">SMS Quantity: <span className="font-medium text-gray-800">{pkg.quantity}</span></p>
              </div>
              <Button className="w-full justify-center bg-blue-600 hover:bg-blue-700 text-white gap-2 mt-auto">
      ...
      <Card className="min-h-[100px] border border-gray-200 shadow-sm">
        <div />
      </Card>
    </div>
  )
