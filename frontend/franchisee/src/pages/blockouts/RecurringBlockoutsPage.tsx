...
import { Search, Plus, Check, ChevronLeft, ChevronRight, MoreVertical, Trash2 } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Recurring Blockouts</h1>
      </div>
