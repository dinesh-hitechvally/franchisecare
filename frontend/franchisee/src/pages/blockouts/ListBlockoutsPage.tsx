          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="px-5 py-4 text-sm font-semibold text-gray-800 text-center align-top">Recurring</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {isLoading ? (
                <tr>
                  <td colSpan={9} className="px-5 py-8 text-center text-gray-500 italic">Loading blockouts...</td>
                </tr>
              ) : blockouts.length === 0 ? (
                <tr>
                  <td colSpan={9} className="px-5 py-8 text-center text-gray-500 italic">No blockouts found.</td>
                </tr>
              ) : (
                blockouts.map((row: Blockout) => (
