...
import { Phone, ChevronLeft, ChevronRight, MoreVertical, XCircle } from 'lucide-react'
...
export function CancellationRequestPage() {
  ...
  const mapRowToLead = (row: CancellationRow): Lead => ({
    id: row.id,
    ...
    interestedServices: 'Cancellation Request',
    address: row.address,
    suburb: '',
    petBreed: '',
    referredBy: 'Phone',
  ...
  const handleView = (row: CancellationRow) => {
